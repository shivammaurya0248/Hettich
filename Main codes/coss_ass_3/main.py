...
while True:
    try:
        ...
        if status[1] is not None:
            ...
            if curr_date != today:
                try:
                    url = f"{URL_GENERAL}/{today}/{MACHINE_NAME}"
            ...
            if curr_shift != 'NA':
                ...
                if machine_maintenance_status is False:
                    ...
                    if GL_PREV_READY_STATUS != MACHINE_STATUS["ready"]:
                        ...
                        if time.time() - GL_BLINKING_START_TIME > 900 and not GL_BREAKDOWN_STATUS:
                            ...
                            log.info(
                                f'[*]breakdown_status: {breakdown_status}, prev_breakdown_status: {prev_breakdown_status}')
                    ...
                    if GL_BREAKDOWN_STATUS:
                        ...
                        if GL_PREV_READY_STATUS and MACHINE_STATUS['ready']:
                            ...
                            db.update_breakdown_data(curr_date, curr_shift, GL_breakdown_start, GL_breakdown_stop,
                                                     duration)
                else:
