...
ACCESS_TOKEN = "0Stl8YrGxjif4MaZNC1B"
        ...
        if status is not None:
            ...
            if GL_CURR_PART_COUNT is not None and curr_shift != 'NA':
                ...
                if machine_maintenance_status is not True:
                    ...
                    if MACHINE_STATUS['ready'] and not MACHINE_STATUS['healthy'] and MACHINE_STATUS['stop']:
                ...
                log.info(f"Code shift planned production : {shift_planned_production}")
